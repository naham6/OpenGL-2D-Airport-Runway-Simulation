...
void drawPlaneShape(float r, float g, float b) {
    glColor3f(1.0f, 1.0f, 1.0f);
    glBegin(GL_POLYGON);
    glVertex2f(-100.0f, 0.0f); glVertex2f(80.0f, 0.0f);
    glVertex2f(120.0f, 10.0f); glVertex2f(120.0f, 20.0f);
    glVertex2f(80.0f, 40.0f);  glVertex2f(-120.0f, 40.0f);
    glEnd();

    glColor3f(0.0f, 0.1f, 0.3f);
    glBegin(GL_POLYGON);
    glVertex2f(80.0f, 35.0f); glVertex2f(100.0f, 25.0f);
    glVertex2f(110.0f, 20.0f); glVertex2f(80.0f, 20.0f);
    glEnd();

    glColor3f(r, g, b);
    glBegin(GL_TRIANGLES);
    glVertex2f(20.0f, 40.0f); glVertex2f(-40.0f, 40.0f); glVertex2f(-70.0f, 100.0f);
    glVertex2f(20.0f, 0.0f); glVertex2f(-40.0f, 0.0f); glVertex2f(-70.0f, -60.0f);
    glEnd();
    glBegin(GL_POLYGON);
    glVertex2f(-90.0f, 40.0f); glVertex2f(-130.0f, 90.0f);
    glVertex2f(-150.0f, 90.0f); glVertex2f(-120.0f, 40.0f);
    glEnd();
}

void drawAirplane(float x, float y) {
    glPushMatrix();
    glTranslatef(x, y + 60.0f, 0.0f);
    drawPlaneShape(1.0f, 0.0f, 0.0f);
    glPopMatrix();
}
